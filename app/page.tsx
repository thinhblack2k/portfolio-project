...
export default function Home() {
  return (
    <main className="w-screen h-screen relative">
      ...
      >
        <div className=" pl-20 md:pl-40 pb-56 md:pb-20 flex flex-col gap-5 z-[10] max-w-[775px]">
          <h1 className="text-[50px] text-white font-semibold">
            Make anything possiblew with
          ...
          <p className="text-gray-200 hidden md:block">
            ...
            excepturi dolores, earum minus consequatur beatae nisi consectetur
            rerum! Ipsam consectetur in adipisci quaerat aliquam temporibus eius
            similique laborum nulla veniam.
          </p>
